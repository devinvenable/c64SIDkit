...
PRESETS = {
    ...
    "powerup_speed": SfxPatch(
        ...
        attack=0, decay=5, sustain=10, release=3,
        pw_hi=0x00, duration_frames=25,
        sweep_target_hi=0x4F, sweep_target_lo=0xD2,
        sweep_frames=25, sweep_type="exponential",
        vibrato_rate=12.0, vibrato_depth=40,
        description="Rising sawtooth rush — speed powerup collect",
    ),
}
